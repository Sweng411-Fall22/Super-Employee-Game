...
class Soldier(pygame.sprite.Sprite):
    ...
    def move(self, moving_left, moving_right):
        ...
        if self.char_type == 'player':
            if self.rect.left + dx < 0 or self.rect.right + dx > self.game.SCREEN_WIDTH:
                dx = 0
        ...
        if self.char_type == 'player':
            if (self.rect.right > self.game.SCREEN_WIDTH - self.game.SCROLL_THRESH and self.game.bg_scroll < (self.game.world.level_length * self.game.TILE_SIZE) - self.game.SCREEN_WIDTH)\
                or (self.rect.left < self.game.SCROLL_THRESH and self.game.bg_scroll > abs(dx)):
                self.rect.x -= dx
                screen_scroll = -dx
    ...
    def shoot(self):
        if self.shoot_cooldown == 0 and self.ammo > 0:
            ...
            self.bullet = bull.Bullet(self.game, self.rect.centerx + (0.75 * self.rect.size[0] * self.direction), self.rect.centery, self.direction)
